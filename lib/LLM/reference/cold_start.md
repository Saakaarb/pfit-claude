...
consumed_by: [pfit-skeleton, pfit-new, pfit-check, pfit-jax, pfit-diagnose]
generated: false
owns: >
...
|---|---|---|
| **Setup** | `/pfit-skeleton`, `/pfit-new`, `/pfit-check`, `/pfit-jax` | equations, dataset, bounds. **No solution artifact of any session.** |
