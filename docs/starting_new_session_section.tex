...
bounds, observables, and column declarations. The model file records the ODE
right-hand side, forcing interpolation, calculated observables, and the masked
uncertainty-weighted loss over both measured channels. The user then reviews the generated state ordering,
